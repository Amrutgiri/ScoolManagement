            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="{{url('admin/school_info')}}">School Details</a>
                        </li>
                        <li>
                            <a href="{{url('admin/carousel')}}">Carousel</a>
                        </li>
                        <li>
                            <a href="{{url('admin/welcomesection')}}">Welcome Section</a>
                        </li>
                        <li>
                            <a href="{{url('admin/achivements')}}">Achivements</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{url('admin/createpages')}}">Create Custom Pages</a>
                        </li>
                        <li>
                            <a href="{{url('admin/notifications')}}">Manage Notification</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="{{url('admin/manageschool')}}">Manage School</a>
                        </li>
                        <li>
                            <a href="{{url('admin/letterpad')}}">Letter Pad</a>
                        </li>
                        <li>
                            <a href="{{url('admin/inwards')}}">Inwards</a>
                        </li>
                        <li>
                            <a href="{{url('admin/schoolconfig')}}">School Config</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="{{url('admin/designation')}}">Designation</a>
                        </li>
                        <li>
                            <a href="ecommerce-prduct-detail.html">Class Teacher</a>
                        </li>
                        <li>
                            <a href="ecommerce-product-edit.html">My Remark</a>
                        </li>
                        <li>
                            <a href="ecommerce-orders.html">Shift</a>
                        </li>
                        <li>
                            <a href="ecommerce-sellers.html">Manage Certificate</a>
                        </li>
                        <li>
                            <a href="ecommerce-sellers.html">Reminder</a>
                        </li>
                    </ul>
                </li>
